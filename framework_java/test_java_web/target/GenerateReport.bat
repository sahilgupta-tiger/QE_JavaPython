...
powershell.exe "Copy-Item -Path allure-report\history\* -Destination allure-results\history -PassThru"
powershell.exe "Copy-Item -Path allure-report\widgets\* -Destination allure-results\widgets -PassThru"
